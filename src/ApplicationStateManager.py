...
def main():
    ...
    for class_needing_queue in process_classes:
    ...
    process_objects = {}
    for class_needing_init in process_classes:
    ...
    pool = Pool(processes=len(process_classes))
    ...
    for class_needing_launch in process_classes:
    ...
    while True:
        for class_needing_check in process_classes:
